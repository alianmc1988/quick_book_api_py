...
from src.Business_Module.services.busines_usecases.update_business_use_case import Update_Business_Usecase
...
class Update_Business_Controller(Base_Controller):
    ...
    async def handle(self, id:str, business_payload:Update_Business_DTO):
        return await self.use_case.execute(business_id=id, business_payload=business_payload)