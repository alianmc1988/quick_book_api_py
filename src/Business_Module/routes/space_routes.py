...
from src.Business_Module.controllers.business_controllers.delete_business_controller import Delete_Business_Controller
...
from src.Business_Module.controllers.space_controllers.create_space_controller import Create_Space_Controller
from src.Business_Module.controllers.space_controllers.delete_space_controller import Delete_Space_Controller
from src.Business_Module.controllers.space_controllers.find_space_byId_controller import Find_Space_ById_Controller
from src.Business_Module.controllers.space_controllers.list_spaces_controller import List_Spaces_Controller
from src.Business_Module.controllers.space_controllers.update_space_controller import Update_Space_Controller
...
from src.Business_Module.services.busines_usecases.delete_business_use_case import Delete_Business_Usecase, delete_business_usecase
...
from src.Business_Module.services.space_usecases.create_space_use_case import Create_Space_Usecase, get_create_space_usecase
from src.Business_Module.services.space_usecases.delete_space_use_case import Delete_Space_Usecase, get_delete_space_usecase
from src.Business_Module.services.space_usecases.find_space_byId_use_case import Find_Space_ById_Usecase, get_find_space_byId_usecase
from src.Business_Module.services.space_usecases.list_spaces_use_case import List_Spaces_Usecase, get_list_spaces_usecase
from src.Business_Module.services.space_usecases.update_space_use_case import Update_Space_Usecase, get_update_space_usecase
...
async def create_space(space_payload: Create_Space_DTO, create_space_use_case: Create_Space_Usecase = Depends(get_create_space_usecase)):
...
async def list_spaces(business_id:str, list_spaces_use_case: List_Spaces_Usecase = Depends(get_list_spaces_usecase)):
...
async def find_space_by_id(id:str, find_space_byId_use_case: Find_Space_ById_Usecase = Depends(get_find_space_byId_usecase)):
...
async def update_space(id:str, space_payload:Update_Space_DTO,update_space_use_case: Update_Space_Usecase = Depends(get_update_space_usecase)):
...
async def delete_space(id:str, delete_space_usecase: Delete_Space_Usecase = Depends(get_delete_space_usecase)):
