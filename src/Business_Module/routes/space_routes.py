...
# async def delete_business(id:str, delete_business_usecase: Delete_Business_Usecase = Depends(delete_business_usecase)):
#     controller = Delete_Business_Controller(use_case=delete_business_usecase)
#     return await controller.handle(business_id=id)
