...
def convert_numeric_to_literal_role(role_number:Staff_Role_Type_Enum)->Staff_Role_literal_Enum:
...
def conver_literal_to_numeric_role(role_name: Staff_Role_literal_Enum)->Staff_Role_Type_Enum:
